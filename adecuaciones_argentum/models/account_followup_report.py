...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_columns_name(self, options):
        ...
        """
        headers = [{},
                   {'name': _('Contacto'), 'style': 'text-align:left; white-space:nowrap;'},
                   ...
                   {'name': _('Comprobante'), 'style': 'text-align:right; white-space:nowrap;'},
    ...
    def _get_lines(self, options, line_id=None):
        ...
        for currency, aml_recs in res.items():
            ...
            for aml in aml_recs:
                ...
                if is_payment:
                    date_due = ''
                move_line_name = aml.move_id.l10n_latam_document_number if aml.move_id.l10n_latam_document_number else self._format_aml_name(aml.name, aml.move_id.ref)
                if self.env.context.get('print_mode'):
                ...
                contact = aml.move_id.partner_id.name
                columns = [
                    contact,
